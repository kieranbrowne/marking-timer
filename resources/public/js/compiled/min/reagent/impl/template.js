...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__9830__auto__,writer__9831__auto__,opt__9832__auto__){
return cljs.core._write(writer__9831__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__15585 = o;
(G__15585[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__9212__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__9212__auto__){
var and__9212__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__9212__auto____$1)){
...
var G__15594 = jsprops;
(G__15594["defaultValue"] = value);

(G__15594["onChange"] = ((function (G__15594,v,value,on_change){
return (function (p1__15591_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__15591_SHARP_);
});})(G__15594,v,value,on_change))
);

(G__15594["ref"] = ((function (G__15594,v,value,on_change){
return (function (p1__15592_SHARP_){
return (this$["cljsInputElement"] = p1__15592_SHARP_);
});})(G__15594,v,value,on_change))
);
...
var vec__15601 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15601,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15601,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15601,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___15606 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___15606 == null)){
} else {
var key_15607 = temp__4661__auto___15606;
(jsprops["key"] = key_15607);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__15609 = (new reagent.impl.template.NativeWrapper());
(G__15609["name"] = c);
...
var G__15611 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__15611) : reagent.impl.template.as_element.call(null,G__15611));
} else {
...
var len__10299__auto___15617 = arguments.length;
var i__10300__auto___15618 = (0);
while(true){
if((i__10300__auto___15618 < len__10299__auto___15617)){
args__10306__auto__.push((arguments[i__10300__auto___15618]));

var G__15619 = (i__10300__auto___15618 + (1));
i__10300__auto___15618 = G__15619;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__10307__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15615){
var G__15616 = cljs.core.first(seq15615);
var seq15615__$1 = cljs.core.next(seq15615);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__15616,seq15615__$1);
});
...
break;
default:
var G__15623 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__15623;
continue;
...
var n__10139__auto___15626 = a.length;
var i_15627 = (0);
while(true){
if((i_15627 < n__10139__auto___15626)){
(a[i_15627] = reagent.impl.template.as_element((a[i_15627])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__10139__auto___15629 = a.length;
var i_15630 = (0);
while(true){
if((i_15630 < n__10139__auto___15629)){
var val_15631 = (a[i_15630]);
if((cljs.core.vector_QMARK_(val_15631)) && ((reagent.impl.template.key_from_vec(val_15631) == null))){
(o["no-key"] = true);
} else {
}

(a[i_15630] = reagent.impl.template.as_element(val_15631));

var G__15632 = (i_15630 + (1));
i_15630 = G__15632;
continue;
} else {
}
...
var ctx = ({});
var vec__15636 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15636,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15636,(1),null);
...
var G__15640 = (cljs.core.count(argv) - first_child);
switch (G__15640) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__15640){
